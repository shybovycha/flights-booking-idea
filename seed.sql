...
create table users (ID int primary key, ROLE text, USERNAME text, PASSWORD text);
...
create table tickets (ID int primary key, STATUS text, ADDRESS text, EMAIL text, NAME text, OWNERFROM text, PHONE text, FLIGHTID int);
